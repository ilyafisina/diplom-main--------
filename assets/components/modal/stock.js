...
return (
    <View style={{borderWidth:1, borderRadius:20,padding:10}}>
    <View>
        <Text style={{fontSize:20, textAlign:'center'}}>ВЫБЕРИТЕ РАЗМЕР СТАКАНЧИКА</Text>
    </View>
    ...
    flexDirection: 'row', marginBottom:60, marginTop:40, marginLeft:70, marginRight:20}}>
      ...
      <View>
          <Image style={{width:100,height:100}} source={require('../../images/stock.png')}></Image>
          <Text style={{textAlign:'center'}}>0.2</Text>
          </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={(handlePress2)}
       style={[styles.isTouch,isDisabled2 && styles.appButtonDisabled]} disabled={isDisabled2}>
          <View >
          <Image style={{width:100,height:120}} source={require('../../images/stock.png')}></Image>
       ...
       style={[styles.isTouch,isDisabled3 && styles.appButtonDisabled]} disabled={isDisabled3}>
          <Image style={{width:100,height:140}} source={require('../../images/stock.png')}></Image>
          <Text style={{textAlign:'center'}}>0.7</Text>
          </TouchableOpacity>
          </View>
          </ScrollView>
        </View>
